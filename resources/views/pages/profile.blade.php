    ...
    <div class="row-form">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="password" name='password' class="form-control" id="inputPassword4" placeholder="**********" readonly>
                    <br>
                    <label for="inputAge">Birth Date</label>
                    <input type="date" value='{{$user->birthdate}}' name='birthdate' class="form-control" id="inputAge" placeholder="{{$user->birthdate}}" readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" value='{{$address->street}}' name='street' class="form-control" id="inputAddress" placeholder="{{$address->street}}" readonly>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputCity">City<a class="text-danger">*</a></label>
                    <input type="text" value='{{$address->city->name}}' name='city' class="form-control" id="inputCity" placeholder="{{$address->city->name}}"
                        readonly>
                </div>
                <div class="form-group col-md-2">
                    <label for="inputZip">Postal Code<a class="text-danger">*</a></label>
                    <input type="text" value='{{$address->postalcode}}' name='postalcode' class="form-control" id="inputZip" placeholder="{{$address->postalcode}}"
                        readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" value='{{$address->street}}' name='streetbd' class="form-control" id="inputAddress" placeholder="{{$address->street}}" readonly>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputCity">City</label>
                    <input type="text" value='{{$address->city->name}}' name='citybd' class="form-control" id="inputCity" placeholder="{{$address->city->name}}"
                        readonly>
                </div>
                <div class="form-group col-md-2">
                    <label for="inputZip">Postal Code</label>
                    <input type="text" value='{{$address->postalcode}}' name='postalcodebd' class="form-control" id="inputZip" placeholder="{{$address->postalcode}}"
                        readonly>
                </div>
            </div>
